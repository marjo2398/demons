...
?>
    ...
    <form method="POST">
        <textarea 
            ...
            class="w-full bg-gray-900 border border-gray-600 rounded p-3 text-sm text-indigo-200 font-mono mb-4 focus:ring-1 focus:ring-indigo-500 resize-none overflow-hidden"
